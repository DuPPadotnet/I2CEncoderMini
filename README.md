...
* [Datasheet EncoderMini:](https://github.com/Fattoresaimon/I2CEncoderMini/blob/master/I2CEncoderMini_v1.2.pdf) Datasheet of the board with the description of the registers and some useful information.
